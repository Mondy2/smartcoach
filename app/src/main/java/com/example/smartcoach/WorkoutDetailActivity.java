...
public class WorkoutDetailActivity extends AppCompatActivity {
    ...
    private TextView tvDetailMuscle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvDetailMuscle = findViewById(R.id.tvDetailMuscle);
    ...
    private void loadWorkoutDetails(String userId, String workoutId) {
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                Log.d("WorkoutDetail", "Detail rawGroup='" + rawGroup + "'");
                String keyGroup = (rawGroup == null || rawGroup.isEmpty())
                        ? WorkoutUtils.determineMuscleGroup(workout.getSuggestedWorkout())
                        : rawGroup;
                keyGroup = WorkoutUtils.uiToKeyMuscleGroup(keyGroup);
                Log.d("WorkoutDetail", "Detail keyGroup='" + keyGroup + "'");

                WorkoutUtils.setMuscleImage(muscleImage, keyGroup);

                tvDetailDate.setText(workout.getDate());
                tvDetailGoal.setText("Ціль: " + WorkoutUtils.translateWorkoutGoal(workout.getWorkoutGoal()));

                String uiMuscle = WorkoutUtils.translateMuscleGroup(keyGroup);
                tvDetailMuscle.setText("Група м’язів: " + uiMuscle);

                tvDetailSuggested.setText(WorkoutUtils.translateSuggestedWorkout(workout.getSuggestedWorkout()));
                tvDetailIntensity.setText(WorkoutUtils.translateIntensityLevel(workout.getIntensityLevel()));
