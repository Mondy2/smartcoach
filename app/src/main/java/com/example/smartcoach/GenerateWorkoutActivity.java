...
public class GenerateWorkoutActivity extends AppCompatActivity {
    ...
    private void generateWorkout() {
        ...
        int pos = muscleGroupSpinner.getSelectedItemPosition();
        String raw = muscleGroupSpinner.getSelectedItem().toString();
        Log.d("GenerateWorkout", "Spinner pos=" + pos + ", raw='" + raw + "'");
        ...
        switch (pos) {
            ...
            case 5: // Плечі
                ...
                break;
            default: // 6 и все остальные → «Все тіло» или невыбранное
                // Используем цель тренировки
                switch (fitnessGoal) {
                    case "Схуднення":
...
// Перемішуємо вправи і вибираємо перші 3
        ...
        String chosenGroup = muscleGroupSpinner.getSelectedItem().toString();
        AutoGeneratedWorkout workout = new AutoGeneratedWorkout(
                workoutId, userId, suggestedWorkout,
                duration, intensityLevel, sets, date, fitnessGoal,chosenGroup
        );
